...
-- pokus o insert
INSERT INTO vsetko(student_id, student_name, vsp, lunch_id, was_tasty, restaurant_id, restaurant_name, capacity,
                   location)
VALUES (50, 'Testovaci', 2.5, 64, FALSE, 8, 'neexistujuca', 200, 'fakulty');
...
SELECT *
FROM male_restauracie;

-- tento INSERT prejde, ale vo VIEW sa neprejavi
INSERT INTO male_restauracie(name)
VALUES ('dalsia');
SELECT *
FROM restaurants;
-- DELETE nam neprejde
...
INSERT INTO male_restauracie(name, capacity)
VALUES ('dalsia3', 500);
DELETE
FROM male_restauracie
WHERE id = 9;
...
INSERT INTO male_restauracie2(name)
VALUES ('este dalsia');
